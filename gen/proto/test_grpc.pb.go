...
func (c *testApiClient) Registr(ctx context.Context, in *RegistrRequest, opts ...grpc.CallOption) (*RegistrResponse, error) {
	out := new(RegistrResponse)
	err := c.cc.Invoke(ctx, "/main.TestApi/Registr", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTestApiServer) Registr(context.Context, *RegistrRequest) (*RegistrResponse, error) {
...
func _TestApi_Registr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegistrRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestApiServer).Registr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.TestApi/Registr",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestApiServer).Registr(ctx, req.(*RegistrRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TestApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Registr",
			Handler:    _TestApi_Registr_Handler,
		},
	},
